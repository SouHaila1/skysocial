...
<form action="register.php" method="POST">
	...
	<form action="register.php" method="POST">
		...
		else if(in_array("Your password can only contain english characters or numbers<br>", $error_array)) echo "Your password can only contain characters or numbers<br>";
